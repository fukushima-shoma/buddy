...
class SystemdServiceTest(unittest.TestCase):
    def test_service_starts_safe_wake_word_conversation(self) -> None:
        ...
        self.assertIn("--proactive-interval 900", service)
        self.assertIn("--proactive-start-hour 8", service)
        self.assertIn("--proactive-end-hour 20", service)
        self.assertIn("vosk-model-small-ja-0.22 \\", service)
